...
These documents define the non-negotiable principles that govern every design and engineering decision. Read them before proposing large changes.

| File                                                                                             | What it covers                                                         |
| ------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------- |
| [`philosophy/KanTrack_Engineering_Philosophy.md`](philosophy/KanTrack_Engineering_Philosophy.md) | Engineering principles: local-first, no silent failures, reversibility |
| [`philosophy/KanTrack_Design_Philosophy.md`](philosophy/KanTrack_Design_Philosophy.md)           | Design principles: clarity over features, calm UI                      |
| [`philosophy/KanTrack_Product_Doctrine.md`](philosophy/KanTrack_Product_Doctrine.md)             | Core product rules that cannot be broken at any phase                  |
| [`philosophy/KanTrack_Decision_Checklist.md`](philosophy/KanTrack_Decision_Checklist.md)         | Quick checklist to run before any significant change                   |
...
| File                                                                         | What it covers                                   |
| ---------------------------------------------------------------------------- | ------------------------------------------------ |
| [`vision/README_KanTrack_Manifesto.md`](vision/README_KanTrack_Manifesto.md) | The project manifesto and core mission statement |
