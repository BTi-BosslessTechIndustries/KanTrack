...
│   │   ├── i18n.js               # UI translation: t(), setLanguage(), applyTranslations()
...
│       ├── privacy.spec.js      # privacy.html renders in the language set via cardLanguage
│       ├── search.spec.js       # Live search filtering and ESC clear
│       ├── header.spec.js       # Header UI: dropdown, About modal, Shortcuts modal, language picker, UI translation
